...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\user\\Desktop\\Exp\\StroopExp\\stroop_legacy_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    welcomeComponents = [textWelcomemessage]
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        if textWelcomemessage.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
        ...
        if textWelcomemessage.status == STARTED:
            ...
            if tThisFlipGlobal > textWelcomemessage.tStartRefresh + 1-frameTolerance:
    ...
    for thisTrial in trials:
        ...
        _key_resp_allKeys = []
        # keep track of which components have finished
        trial_2Components = [fixation, text, key_resp]
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['r','g','b','y'], ignoreKeys=None, waitRelease=False)
